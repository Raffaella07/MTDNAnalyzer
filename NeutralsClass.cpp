...
void NeutralsClass::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("primary_x", &primary_x, &b_primary_x);
   fChain->SetBranchAddress("primary_y", &primary_y, &b_primary_y);
   fChain->SetBranchAddress("primary_z", &primary_z, &b_primary_z);
   fChain->SetBranchAddress("primary_phi", &primary_phi, &b_primary_phi);
   fChain->SetBranchAddress("primary_eta", &primary_eta, &b_primary_eta);
   ...
   fChain->SetBranchAddress("conv_x", &conv_x, &b_conv_x);
   fChain->SetBranchAddress("conv_y", &conv_y, &b_conv_y);
   fChain->SetBranchAddress("conv_z", &conv_z, &b_conv_z);
   fChain->SetBranchAddress("conv_phi", &conv_phi, &b_conv_phi);
   fChain->SetBranchAddress("conv_eta", &conv_eta, &b_conv_eta);
